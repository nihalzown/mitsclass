// Aim: Program to perform Exception Handling operations (InterfaceTask).
interface Account {
...
class InterfaceTask implements Account{

    private double bal;
    private double intrate;

    public InterfaceTask(double bal,double intrate){
        this.bal=bal;
...
public class Interface{
    public static void main(String[] args){
        InterfaceTask sa=new InterfaceTask(1000,5);
