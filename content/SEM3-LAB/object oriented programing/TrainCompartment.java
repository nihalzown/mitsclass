// Aim: Program to perform Abstract Class operations (Train TrainCompartmentTask).
import java.util.Scanner;
abstract class TrainCompartmentTask {
    protected int availableSeats;

    public TrainCompartmentTask(int availableSeats) {
...
class FirstClass extends TrainCompartmentTask {
    ...
    public void notice() {
        System.out.println("First Class TrainCompartmentTask: " + availableSeats + " seats available.");
    }
}

class GeneralClass extends TrainCompartmentTask {
    ...
    public void notice() {
        System.out.println("General Class TrainCompartmentTask: " + availableSeats + " seats available.");
    }
}
